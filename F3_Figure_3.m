...
%
% Generate figure 3a/b/c/d: Cascaded envelope interpolation as an adaptive filter
% bank
%
% this script needs './data/results_efficientCoding_all_speech.mat' which
% can be computed by running 'F3_Figure_3d.m'
%
% If you use this script please cite the following paper
% Thoret, E., Ystad, S., Kronland-Martinet, R. (2023) Hearing as adaptive cascaded envelope interpolation
% Communications Biology
%
% Figure_3a.csv - col 1: frequency, col 2: spectrum, cols 3-8: equivalent filters
% Figure_3b.csv - col 1: frequency, col 2: spectrum, cols 3-8: equivalent filters
% Figure_3b.csv - col 1: frequency, col 2: spectrum, cols 3-8: equivalent filters
% Figure_3d_1.csv - col 1: center frequency, col 2: CEI
% Figure_3d_2.csv - col 1: center frequency, col 2: ERB, col 3: 1/3 octave
% Figure_3d_3.csv - col 1: CEI mean, col 2: CEI standard deviation
...
% Figure_3a.csv - col 1: frequency, col 2: spectrum, cols 3-8: equivalent
% filters
matrixtowrite = [freq_, pow2db(spec), pow2db(tabFilterMoy')];
writematrix(matrixtowrite, './out/csv/Figure_3a.csv') ;
...
ylabel('Attenuation (dB)')
title('Pure tones')
% Figure_3b.csv - col 1: frequency, col 2: spectrum, cols 3-8: equivalent
% filters
matrixtowrite = [freq_, pow2db(spec), pow2db(tabFilterMoy')];
writematrix(matrixtowrite, './out/csv/Figure_3b.csv') ;
...
% Figure_3c.csv - col 1: frequency, col 2: spectrum, cols 3-8: equivalent
% filters
matrixtowrite = [freq_, pow2db(spec), pow2db(tabFilterMoy')];
writematrix(matrixtowrite, './out/csv/Figure_3c.csv') ;
...
writematrix(matrixtowrite, './out/csv/Figure_3d_1.csv') ;

% Figure_3d_2.csv - col 1: center frequency, col 2: ERB, col 3: 1/3 octave
matrixtowrite = [cfTab_vec(1:end-1)', ERB_linear, onethird_linear];
writematrix(matrixtowrite, './out/csv/Figure_3d_2.csv') ;

% Figure_3d_3.csv - col 1: CEI mean, col 2: CEI standard deviation
matrixtowrite = [bdwTab_mean', bdwTab_std'];
writematrix(matrixtowrite, './out/csv/Figure_3d_3.csv') ;

%%
saveas(gca,'./out/eps/F3_Figure_3.eps','epsc2')
saveas(gca,'./out/fig/F3_Figure_3.fig','fig')
