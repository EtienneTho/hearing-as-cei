...
%
% Figure_4.csv - col 1: delta_f/f, col 2: 250 Hz, col 3: 500 Hz, col 4: 1000 Hz, col 5: 2000 Hz
...
% Figure_4.csv - col 1: delta_f/f, col 2: 250 Hz, col 3: 500 Hz, col 4: 1000 Hz, col 5: 2000 Hz
writematrix(matrixtowrite, './out/csv/Figure_4.csv') ;
...
setPlotProp(opt);
%%
saveas(gca,'./out/eps/F4_Figure_4.eps','epsc2')
saveas(gca,'./out/fig/F4_Figure_4.fig','fig')
