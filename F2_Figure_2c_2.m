...
%
% Generate figure 2b: Combination tone, theoretical vs. simulated
% spectrum
%
...
%%
saveas(gca,'F2_Figure_2c_2.eps','epsc')
saveas(gca,'F2_Figure_2c_2.fig','fig')

matrixtowrite = [f_2f1_f2_tab(:), f_2f1_f2_emd_tab(:)];
writematrix(matrixtowrite, 'Figure_2c_2.csv') ;
