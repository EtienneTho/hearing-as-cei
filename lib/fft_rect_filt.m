...
ff ( 1      : idx1-1 ) = 0.1;  % empty index range in case of LOW  pass
ff ( idx2+1 : idx3-1 ) = 0.1;  % empty index range in case of HIGH pass
ff ( idx4+1 : N      ) = 0.1;  % empty index range in case of LOW  pass
