...
save('siftingOptimizationFramework.mat') ;
%%
load('siftingOptimizationFramework.mat') ;
...
writematrix(matrixtowrite, 'Figure_5b_2.csv') ;

%%
saveas(gca,'F5_Figure_5b_2.eps','epsc')
saveas(gca,'F5_Figure_5b_2.fig','fig')
