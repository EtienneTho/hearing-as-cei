...
%
% Figure_6.csv - col 1: interval, col 2: simulated dissonnance, col 3: theoretical dissonance
...
setPlotProp(opt);
%%
matrixtowrite = [a_tab',toPlot, consonanceCurve] ;
% Figure_6.csv - col 1: interval, col 2: simulated dissonnance, col 3: theoretical dissonance
writematrix(matrixtowrite, './out/csv/Figure_6.csv') ;

%%
saveas(gca,'./out/eps/F6_Figure_6.eps','epsc')
saveas(gca,'./out/fig/F6_Figure_6.fig','fig')
